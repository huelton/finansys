...
protected formBuilder: FormBuilder;
  ...
  constructor(
    ...
    protected jsonDataDataResourceFn: (jsonData) => T
...
submitForm() {
  ...
  protected createResource() {
    const resource: T = this.jsonDataDataResourceFn(this.resourceForm.value);
  ...
  protected updateResource() {
    ...
    this.resourceService.update(resource)
         .subscribe(
             resource => this.actionsForUpdate(resource),
             error => this.actionsForError(error)
         )
  }
